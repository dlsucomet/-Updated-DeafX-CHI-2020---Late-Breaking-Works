...
%      \centering
%     \includegraphics[width=4.75cm,height=3cm]{figures/Prot1.png}
%   \caption{A sample screenshot of the first prototype}
%     \label{fig:prot1}
%     \end{minipage}
% \end{marginfigure}
...
% \begin{minipage}{\marginparwidth}
%      \centering
%     \includegraphics[width=4.75cm,height=3cm]{figures/Prot2.png}
%   \caption{A sample screenshot of the second prototype}
%     \label{fig:prot2}
%     \end{minipage}
% \end{marginfigure}
...
% for results dapat to The responses deemed a visualization application to be viable as a tool to augment the musical experience of the DHH

% for results dapat tothe results showed that the participants favored more abstract visualizations, such as transforming shapes which change in color, over visuals such as moving stick figures.


% Surveys on the relationships between visual elements—such as color, shape, mo—and affects, were also conducted, and its results were later used to cross-validate the results acquired from the next survey, which was about the relationship between musical scales, affect, and color. These results were mapped onto Russell's circumplex model of affect \cite{Russel:1980} by associating the musical scales with affect and by determining their valence and arousal values.
...
\begin{marginfigure}[-5pc]
\begin{minipage}{\marginparwidth}
     \includegraphics[width=4.5cm,height=2cm]{figures/TrendsNew.png}
